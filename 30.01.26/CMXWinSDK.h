...
unsigned int CmxMTSetChannel(unsigned int Handle, TimerChannel Channel,unsigned int PreScaler,unsigned int Period,unsigned int Polarity,unsigned int *Error);
...
unsigned int CmxTCSetGain (unsigned int Handle, unsigned int Channel, unsigned int TC_Type, unsigned int SubRegion, double Gain, unsigned int *Error);
unsigned int CmxTCGetGain (unsigned int Handle, unsigned int Channel, unsigned int TC_Type, unsigned int SubRegion, double *Gain, unsigned int *Error);
unsigned int CmxTCSetOffset (unsigned int Handle, unsigned int Channel, unsigned int TC_Type, unsigned int SubRegion, double Offset, unsigned int *Error);
unsigned int CmxTCGetOffset (unsigned int Handle, unsigned int Channel, unsigned int TC_Type, unsigned int SubRegion, double *Offset, unsigned int *Error);
unsigned int CmxTCApplyTempCalibration (unsigned int Handle, unsigned int *Error);
unsigned int CmxTCSetADCGain (unsigned int Handle, unsigned int Channel, unsigned int SubRegion, double Gain, unsigned int *Error);
unsigned int CmxTCGetADCGain (unsigned int Handle, unsigned int Channel, unsigned int SubRegion, double *Gain, unsigned int *Error);
unsigned int CmxTCSetADCOffset (unsigned int Handle, unsigned int Channel, unsigned int SubRegion, double Offset, unsigned int *Error);
unsigned int CmxTCGetADCOffset (unsigned int Handle, unsigned int Channel, unsigned int SubRegion, double *Offset, unsigned int *Error);
unsigned int CmxTCApplyADCCalibration (unsigned int Handle, unsigned int *Error);
...
unsigned int CmxTCGetSerial (unsigned int Handle, unsigned int *SerialNo, unsigned int *Error);
unsigned int CmxTCGetFirmware (unsigned int Handle, double *FwVersion, unsigned int *Error);
